...
public class Shotter {
    ...
    private void sendMessage(String images) {
        SocketIOSender.sendMessage(new SocketIOMessageBody("", "", SocketIOUriParser.buildClientUri("/screenshot")).setMessageKey("imageData", "data:image/png;base64," + images));
    }
    ...
    public class SaveTask extends AsyncTask<Image, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Image... params) {
            ...
            if (fileImage != null) {
                String images = bitmapToBase64(bitmap);
                sendMessage(images);
                return bitmap;
            }
            return null;
